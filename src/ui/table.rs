...
pub fn build_table<'a>(
   ...
   Table::new(
      build_rows(entries, ctx, layout.imsa_widths, layout.nls_widths, layout.f1_widths, layout.wec_widths),
      layout.widths,
   )
...
fn build_car_cell(
   ...
   let highlighted_car = is_highlighted_car_number(&e.car_number, highlighted_cars);
