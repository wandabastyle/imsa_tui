...
import type { TimingEntry, Series, TimingClassColor } from '../generated/web-shared';
import { getColumnsForSeries, isCompactColumn } from '../table/columns';
import { computeStableColumnWidths, asChWidths } from '../table/widths';
